...
analysisManager->CreateNtupleIColumn(1,"Event_fFlagMWPC1");
analysisManager->CreateNtupleIColumn(1,"Event_fFlagMWPC2");
analysisManager->CreateNtupleIColumn(1,"Event_fFlagMWPC3");
analysisManager->CreateNtupleIColumn(1,"Event_fFlagE1");
analysisManager->CreateNtupleIColumn(1,"Event_fFlagE2");
analysisManager->CreateNtupleIColumn(1,"Event_fFlagE3");
analysisManager->CreateNtupleIColumn(1,"Event_fFlagdE1");
analysisManager->CreateNtupleIColumn(1,"Event_fFlagdE2");
analysisManager->CreateNtupleIColumn(1,"Event_fFlagdE3");
